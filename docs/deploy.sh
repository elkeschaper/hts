...
Variables:
  ...
  HTS_GIT_DEPLOY_DIR      Folder path containing the files to deploy.
  HTS_GIT_DEPLOY_BRANCH   Commit deployable files to this branch.
  HTS_GIT_DEPLOY_REPO     Push the deploy branch to this repository.
...
parse_args() {
	...
	repo=${HTS_GIT_DEPLOY_REPO:-origin}
